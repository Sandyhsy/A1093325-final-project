...
$link = mysqli_connect( 
    ...
    '',  // 密碼
    'sandystudioacc');
    $SQL="SELECT name FROM accvip WHERE mail='$mail'";
...
<div class="divblock">
    ...
    <center><br><br><?php echo '材質：'.$row['material']; ?><br><br>所有商品都是手工製作👐<br>有小小差異是正常的哦<br>極度完美主義者慎選😱<br>不配戴的時候要放進夾鏈袋或收納盒<br>🧹以免氧化後難以清理哦</center>
    <br>
    <center><img src="photo\81 (1).jpg"></center>
    <center><img src="photo\81 (3).jpg"></center>
</div>
