...
<div class="divblock">
    <?php
        ...
        $sql = "SELECT * FROM accproduct WHERE num=38";
    ...
    <center>個性小姊姊必備<br>有點帥帥的元素<br>可議自行調整戒圍<br><br>菱格戒指內圍：約5.2公分<br>圓珠戒指內圍：約4.6公分<br><br><?php echo '材質：'.$row['material']; ?><br><br>所有商品都是手工製作👐<br>有小小差異是正常的哦<br>極度完美主義者慎選😱<br>不配戴的時候要放進夾鏈袋或收納盒<br>🧹以免氧化後難以清理哦</center>
    <br>
    <center><img src="photo\38.jpg"></center>
    <center><img src="photo\37.5.jpg"></center>
</div>
