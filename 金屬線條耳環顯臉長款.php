...
<?php
    ...
    <center>此款耳環是一體成型夾式的<br>❌所以沒辦法改耳釘<br><br>總長：約5.1cm<br>材質：合金<br><br>所有商品都是手工製作👐<br>有小小差異是正常的哦<br>極度完美主義者慎選😱<br>不配戴的時候要放進夾鏈袋或收納盒<br>🧹以免氧化後難以清理哦</center>
    <br>
    <center><img src="photo\3.1.jpg"></center>
    <center><img src="photo\3.jpg"></center>
</div>
