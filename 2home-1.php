...
<div class="divblock">
    <center><table>
        <tr>
            <td><button onclick="location.href='2home.php'">1</td>
            <td><button onclick="location.href='2home-1.php'">2</td>
    </table></center>
    <br>
    <center><table>
    <?php
        ...
        for($i=1;$i<$count;$i++){
            if($i%2==0){
                ...
                echo "<center><a href='5login.php'><img src='".$row['image']."' width='70%'></center><br>";
