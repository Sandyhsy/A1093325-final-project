...
<div class="divblock">
    ...
    <center>垂墜項鍊 讓你一秒變成天鵝頸<br>修修脖子的好夥伴<br>珍珠元素提升氣質<br>不論是平口衣 或 高領衣都適合搭配<br><br>總長約為40.5公分<br><?php echo '材質：'.$row['material']; ?><br><br>所有商品都是手工製作👐<br>有小小差異是正常的哦<br>極度完美主義者慎選😱<br>不配戴的時候要放進夾鏈袋或收納盒<br>🧹以免氧化後難以清理哦</center>
    <br>
    <center><img src="photo\35.jpg"></center>
    <center><img src="photo\35.2.jpg"></center>
</div>
