...
<div class="divblock">
    <?php
        ...
        $sql = "SELECT * FROM accproduct WHERE num=36";
    ...
    <center>闆娘自留款<br>較中性一點<br>有愛心點綴 增添俏皮感<br>也可以和男友當情侶戒戴<br><br>總長約為40.5公分<br><?php echo '材質：'.$row['material']; ?><br><br>所有商品都是手工製作👐<br>有小小差異是正常的哦<br>極度完美主義者慎選😱<br>不配戴的時候要放進夾鏈袋或收納盒<br>🧹以免氧化後難以清理哦</center>
    <br>
    <center><img src="photo\36.4.jpg"></center>
    <center><img src="photo\36.1.jpeg"></center>
</div>
